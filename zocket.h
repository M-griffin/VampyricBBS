...
#define zlMAX_LOOP_ZOCKETS (10)
    ...
    ZocketError getZocketError()
    {
        return error;
    }
    char *getZocketErrorString()
    {
        return zocketErrorStrings[error];
    }
    ...
    int isOpen()
    {
        return zocketStateFlags & zsOPEN;
    }

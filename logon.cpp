...
void logon::ParseVerify ( char *filename )
{
    ...
    do
    {
        ...
        if ( c == '%' )
        {
            ...
            if ( strcmp ( MCI,"UH" ) == 0 )
            {
                temp += ur->Handle;      // Users Handle
            }
            else if ( strcmp ( MCI,"UN" ) == 0 )
            {
                temp += ur->Name;        // Users Name
            }
            else if ( strcmp ( MCI,"UP" ) == 0 )
            {
                temp += ur->Password;    // Users Password
            }
            else if ( strcmp ( MCI,"US" ) == 0 )
            {
                temp += ur->Sex;         // Users Sex
            }
            else if ( strcmp ( MCI,"BD" ) == 0 )
            {
                temp += ur->BDay;        // Birthday
            }
            else if ( strcmp ( MCI,"NO" ) == 0 )
            {
                temp += ur->UserNote;    // User Note
            }
            else if ( strcmp ( MCI,"WD" ) == 0 )
            {
                temp += ur->Word;        // Secret Word
            }
            else if ( strcmp ( MCI,"EM" ) == 0 )
            {
                temp += ur->Email;       // Users Email
            }

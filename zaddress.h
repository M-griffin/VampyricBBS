...
inline short hton ( short x )
{
    return htons ( x );
}
inline int   hton ( int   x )
{
    return htonl ( x );
}
inline long  hton ( long  x )
{
    return htonl ( x );
}
...
inline void reorderMe ( short  &x )
{
    x = ntohs ( x );
}
inline void reorderMe ( int    &x )
{
    x = ntohl ( x );
}
inline void reorderMe ( long   &x )
{
    x = ntohl ( x );
}
inline void reorderMe ( float  &x )
{
    int a = * ( ( int * ) &x );
    x = * ( float * ) &a;
}
inline void reorderMe ( double &x )
{
    /*** Need to add this*/
}
